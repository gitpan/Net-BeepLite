...
BEGIN { use_ok('Net::BeepLite::Channel');
        use_ok('Net::BeepLite::Message'); };

#########################

# Testing Net::BeepLite::Channel

# the constructor:
my $channel = Net::BeepLite::Channel->new;
ok(defined $channel, 'constructor works');
isa_ok($channel, 'Net::BeepLite::Channel');

# a fake profile
my $fake_profile = {};

# create a real channel
$channel = new Net::BeepLite::Channel(Number  => 1,
				      Window  => 1024,
...
my $msg = new Net::BeepLite::Message(Type    => 'RPY',
				     Msgno   => 12,
				     Channel => 1,
...
$msg = new Net::BeepLite::Message(Type 	  => 'ANS',
				  Msgno   => 13,
				  Ansno   => 1,
				  Channel => 1,
				  Content => $large_content);
