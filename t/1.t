...
BEGIN { use_ok('Net::BeepLite::Frame') };

#########################

# Testing Net::BeepLite::Frame

# the constructor:
my $frame = Net::BeepLite::Frame->new;
ok(defined $frame, 'constructor works');
isa_ok($frame, 'Net::BeepLite::Frame');

$frame = Net::BeepLite::Frame->new(Type    => 'MSG',
				   Msgno   => 100,
				   More    => '*',
				   Seqno   => 10023,
				   Channel => 1);
...
# a SEQ frame.
$frame = Net::BeepLite::Frame->new(Type    => 'SEQ',
				   Channel => 1,
				   Ackno   => 10023,
				   Window  => 8192);
...
$frame = Net::BeepLite::Frame->new(Type    => 'ANS',
				   Msgno   => 100,
				   More    => '.',
				   Seqno   => 10023,
				   Channel => 1,
...
$frame = new Net::BeepLite::Frame(Header => $example_header);
